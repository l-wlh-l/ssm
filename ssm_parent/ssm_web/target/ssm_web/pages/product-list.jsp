			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<form action="${pageContext.request.contextPath}/product/delete" method="post" id="productDelete">
						<!--数据列表-->
						<table id="dataList"
								...
								<c:forEach items="${pageBean.pageList}" var="product">
									<tr>
										...
										<td class="text-center">
											...
											<button type="button" class="btn bg-olive btn-xs"
													onclick='location.href="${pageContext.request.contextPath}/product/editUI?id=${product.id}"'>查看</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
